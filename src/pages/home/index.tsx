  ...
  return (
    <div className={home}>
      ...
      <CardBox>
        ...
        <Link to="/books">
          <Card imageUrl="/images/home-books.jpg">
            <div className={cl(textPosition, textPositionTop, textPositionRight)}>
              <h2>Books</h2>
            </div>
          </Card>
        </Link>
        <Link to="/photography">
          <Card imageUrl="/images/home-photography.jpg">
            <div className={cl(textPosition, textPositionBottom, textPositionLeft)}>
              <h2>Photography</h2>
            </div>
          </Card>
        </Link>
